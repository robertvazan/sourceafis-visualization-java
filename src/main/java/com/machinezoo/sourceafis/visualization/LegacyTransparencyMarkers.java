...
public class LegacyTransparencyMarkers {
	 ...
	 */
	public static LegacyTransparencyPixmap paintBooleanMatrix(BooleanMatrix matrix, int foreground, int background) {
		LegacyTransparencyPixmap writable = new LegacyTransparencyPixmap(matrix.size());
